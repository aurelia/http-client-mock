define(['exports', 'aurelia-http-client', 'aurelia-dependency-injection'], function (exports, _aureliaHttpClient, _aureliaDependencyInjection) {
  'use strict';

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.HttpClientMock = exports.ExpectationBuilder = exports.Expectation = exports.RequestHandler = exports.XMLHttpRequestMock = undefined;

  var http = _interopRequireWildcard(_aureliaHttpClient);
  ...
  var XMLHttpRequestMock = exports.XMLHttpRequestMock = (_temp = _class = function () {
  ...
  var Expectation = exports.Expectation = function () {
  ...
  var ExpectationBuilder = exports.ExpectationBuilder = function () {
  ...
  var HttpClientMock = exports.HttpClientMock = function (_http$HttpClient) {
    ...
    HttpClientMock.prototype.registerGlobally = function registerGlobally() {
      new _aureliaDependencyInjection.Container().makeGlobal();
      _aureliaDependencyInjection.Container.instance.registerInstance(http.HttpClient, this);
    };
